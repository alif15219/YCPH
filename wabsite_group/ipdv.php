...
include('navbar_tem.php')
    ...
    <main id="main">
        ...
        <!-- ======= โครงสร้าง ======= -->
        <section id="โครงสร้าง" class="featured-services">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">โครงสร้าง</h2>
                </div>
                <center> <img src="assets/img/slide/ipdv.jpg" alt="คำอธิบายรูปภาพ"
        ...
        <!-- ======= ขอบเขต ======= -->
        <section id="ขอบเขต" class="cta">
            <div class="container" data-aos="zoom-in">
                <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">ขอบเขต</h2>
                </div>
        ...
        <section id="อัตรากำลัง" class="about">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">อัตรากำลัง</h2>
                </div>
        ...
        <section id="เเผนงานโครงการ" class="counts">
            <div class="container" data-aos="fade-up">
            <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">เเผนงานโครงการ</h2>
                </div>
        ...
        <!-- ======= SPQ67 Section ======= -->
        <section id="SPQ67" class="features">
            <div class="container" data-aos="fade-up">
            <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">service profile QA 67</h2>
                </div>
        ...
        <section id="ทบทวน12โปรเเกรม" class="services services">
            <div class="container" data-aos="fade-up">
            <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">ทบทวน 12 โปรเเกรม</h2>
                </div>
        ...
        <!-- ======= ผลงาน Section ======= -->
        <section id="ผลงานภาคภูมิใจ" class="appointment section-bg">
            <div class="container" data-aos="fade-up">
            <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">ผลงานภาคภูมิใจ</h2>
                </div>
        ...
        <!-- ======= ภาพกิจกรรม Section ======= -->
        <section id="ภาพกิจกรรม" class="departments">
            <div class="container" data-aos="fade-up">
            <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">ภาพกิจกรรม</h2>
                </div>
        ...
        <!-- ======= CNPG Section ======= -->
        <section id="CNPG" class="testimonials">
            <div class="container" data-aos="fade-up">
            <div class="section-title">
                    <h2  style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">แนวปฏิบัติ/CNPG</h2>
                </div>
