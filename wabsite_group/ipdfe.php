    ...
    <main id="main">
        ...
        <section id="services1" class="featured-services">
            <div class="container" data-aos="fade-up">
                ...
                <center> <img src="assets/img/slide/10050890.jpg" alt="คำอธิบายรูปภาพ"
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-lg-6" data-aos="fade-right">
                            <img src="assets/img/slide/ward_ipdf.jpg" class="img-fluid"
                                alt="Women's Healthcare Services">
                        </div>
                        <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
                            <h3><i class="bi bi-heart-pulse"></i> รายละเอียดการรักษาพยาบาลผู้ป่วยหญิง</h3>
                            <p>
                            <ul>
                                <li><i class="bi bi-check-circle"></i> ให้บริการรักษาพยาบาลผู้ป่วยหญิงในแผนก:
                                    <ul>
                                        <li><i class="bi bi-dash"></i> อายุรกรรม</li>
                                        <li><i class="bi bi-dash"></i> ศัลยกรรม</li>
                                        <li><i class="bi bi-dash"></i> กุมาเวชกรรม</li>
                                        <li><i class="bi bi-dash"></i> จิตเวช</li>
                                        <li><i class="bi bi-dash"></i> หู คอ จมูก</li>
                                        <li><i class="bi bi-dash"></i> ทารกที่มีภาวะติดเชื้อ</li>
                                        <li><i class="bi bi-dash"></i> นรีเวชกรรม</li>
                                    </ul>
                                </li>
                                <li><i class="bi bi-check-circle"></i> ดูแลหญิงตั้งครรภ์ที่มีภาวะเจ็บป่วย:
                                    <ul>
                                        <li><i class="bi bi-dash"></i> อายุครรภ์ต่ำกว่า 24 สัปดาห์</li>
                                        <li><i class="bi bi-dash"></i> อายุครรภ์มากกว่า 24
                                            สัปดาห์ที่ไม่มีภาวะทางสูติศาสตร์</li>
                                    </ul>
                                </li>
                                <li><i class="bi bi-check-circle"></i> ให้บริการผู้ป่วยในห้องแยกโรคหญิง (ไม่มีภาวะวิกฤต)
                                    จำนวน 4 ห้อง</li>
                            </ul>
                            </p>
                        </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="2" data-purecounter-duration="1"
                                class="purecounter"></span>
                            <p><strong>พนักงานช่วยเหลือคนไข้ (จ้างเหมาบริการ)</strong></p>
                            <a href="#">Find out more &raquo;</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="2" data-purecounter-duration="1"
                                class="purecounter"></span>
                            <p><strong>พนักงานผู้ช่วยพยาบาล (พกส. และลูกจ้างเหมาบริการ)</strong></p>
                            <a href="#">Find out more &raquo;</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="1" data-purecounter-duration="1"
                                class="purecounter"></span>
                            <p><strong>พนักงานบริการ (พกส.)</strong></p>
                            <a href="#">Find out more &raquo;</a>
                        </div>
                    </div>
        ...
        <section id="services4" class="counts">
            <div class="container" data-aos="fade-up">
                ...
                <center><iframe style="position:relative;padding-top:0;width:900px;height:500px;" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQoO7eQMZPy2TULnjL7bsJ75zEP8vIg8D_F6lI45oGHlQn-KYJyZHAEJxKIhMDB7Nl5V6U__NCs2-lY/pubhtml?widget=true&amp;headers=false"></iframe>
                </center>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <center>
                    <div style="position:relative;padding-top:0;width:900px;height:500px;"><iframe
                            ...
                            src="https://online.fliphtml5.com/nmjby/sbqh/" seamless="seamless" scrolling="no"
        ...
        <!-- ======= ผลงาน Section ======= -->
        <section id="services7" class="gallery">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2
                        style="font-family: 'TH Sarabun New', sans-serif; font-size: 4em; font-weight: bold; color: #2f2f2f;">
        ...
        $directory = 'assets/img/gallery/ipdfe'; 
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="gallery-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <?php
        // ระบุโฟลเดอร์ที่เก็บรูปภาพ
        $directory = 'assets/img/gallery/ipdfe_1'; 
        $images = array_diff(scandir($directory), array('..', '.')); // ดึงไฟล์ทั้งหมดในโฟลเดอร์ ยกเว้น . และ ..
        ...
        <section id="services9" class="testimonials">
            <div class="container" data-aos="fade-up">
                ...
                <?php
                $directory = '/var/www/html/wabsite_group/assets/img/file/cnpg'; // ไดเรกทอรีของไฟล์
                ...
                <table class="table table-hover" id="documentTable">
                    ...
                    <tbody id="fileTable">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo "/wabsite_group/assets/img/file/cnpg/" . htmlspecialchars($file); ?>"
